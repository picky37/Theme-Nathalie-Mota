<?php get_header(); ?>
<main class="wrap">
  <img class="image_header_desktop" src="/wp-content/themes/Theme-Nathalie-Mota/images/image_header_desktop.png" alt="Réunion de plusieurs personnes pour une fête">
